...
#define STRING_CONFIG_H_AUTHOR "(MrKich, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RevolveR"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 372.5 // 376.5 // mm // 357.5 + 9.5 * 2

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 207.84 // mm
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 845 /*200 * 16 / (7 * 3.141592653)*/, 1000 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 25, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 1500, 1000, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0.6  // Z offset: -below +above  [the nozzle] // if changed to bigger value, then there would be more table vertical space
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   30 // 15 // Z Clearance for Deploy/Stow
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_PROBE_PT_1_X DELTA_PROBEABLE_RADIUS / 2.0 // These set the probe locations for when UBL does a 3-Point leveling
  #define UBL_PROBE_PT_1_Y 0.8660254 * DELTA_PROBEABLE_RADIUS // of the mesh.
  #define UBL_PROBE_PT_2_X DELTA_PROBEABLE_RADIUS / 2.0
  #define UBL_PROBE_PT_2_Y 0.8660254 * DELTA_PROBEABLE_RADIUS
  #define UBL_PROBE_PT_3_X -DELTA_PROBEABLE_RADIUS
  #define UBL_PROBE_PT_3_Y 0.0
...
#define MANUAL_Z_HOME_POS 224.0 //230.57 // Distance between the nozzle to printbed after homing
